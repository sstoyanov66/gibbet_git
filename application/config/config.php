...
date_default_timezone_set('Europe/Sofia'); // needed for logs and calendars
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
...
$config['base_url'] = 'https://nariad.sstoyanov.eu/'; 
*/
//IMPORTANT !!! _ Dynamically Setting Base URL in CodeIgniter 3 depending on what users enter and where
$protocol = is_https() ? "https://" : "http://";
$host = isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : "";

if(is_cli()){ //<-- Codeigniter function to check if the site is accessed from Command Line Interface (CLI)
...
|	4 = All Messages
|	5 = Custom (see protected $_levels in system/core/log.php where custom is added for custom log files)
...
|
*/
$config['log_threshold'] = array(1, 5); // defualt is $config['log_threshold'] = 0;
...
|
*/
$config['encryption_key'] = 'y1iieyva';
